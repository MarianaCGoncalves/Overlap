...
insert into eventos (eve_ug_id, eve_name, eve_desc, eve_evt_id, eve_ts) values (5,'WatchParty','WatchParty no grupo de discord! Link do grupo:',3, TO_TIMESTAMP ('2022-10-10 14:10:25', 'YYYY-MM-DD HH24:MI:SS')); --Evento no grupo da Alfa Romeo criado pelo Pablo Diaz. )
insert into eventos (eve_ug_id, eve_name, eve_desc, eve_evt_id, eve_ts) values (6,'Beber um café', 'Vamos beber um café no Patio café, para falar sobre as estrategias da Alpine.',2, TO_TIMESTAMP ('2022-09-25 14:30:25', 'YYYY-MM-DD HH24:MI:SS')); --Evento no grupo da Alpine criado pelo José Almeida )

insert into eveonline (eve_on_ug_id, eve_on_dt, eve_on_eve_id) values (5,to_date('2022.10.10','YYYY.MM.DD'),2); -- Evento Online da Alfa Romeo.
...
insert into evefisico (eve_phy_ug_id, eve_phy_dt, eve_phy_eve_id) values (6, to_date('2022.07.25','YYYY.MM.DD'),3); --Evento fisico do grupo Alpine.
