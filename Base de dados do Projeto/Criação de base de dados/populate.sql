...
insert into grupos (gru_name, gru_desc, gru_create_age, gru_last_post_age, gru_at) values ('Grupo Ferrari','Grupo que junta pessoas com interesse na equipa de f1 Ferrari.',to_date('2022.09.9','YYYY.MM.DD'),TO_TIMESTAMP ('10-Sep-02 13:23:10.123000', 'DD-Mon-RR HH24:MI:SS.FF'),TRUE); -- Criação do grupo Ferrari.
insert into grupos (gru_name, gru_desc, gru_create_age, gru_last_post_age, gru_at) values ('Grupo Mercedes','Grupo que junta pessoas com interesse na equipa de f1 Mercedes.',to_date('2022.09.9','YYYY.MM.DD'),TO_TIMESTAMP ('10-Sep-02 13:23:10.123000', 'DD-Mon-RR HH24:MI:SS.FF'),TRUE); -- Criação do grupo Mercedes.
insert into grupos (gru_name, gru_desc, gru_create_age, gru_last_post_age, gru_at) values ('Grupo RedBull','Grupo que junta pessoas com interesse na equipa de f1 RedBull.',to_date('2022.09.9','YYYY.MM.DD'),TO_TIMESTAMP ('10-Sep-02 13:23:10.123000', 'DD-Mon-RR HH24:MI:SS.FF'),TRUE); -- Criação do grupo RedBull.
insert into grupos (gru_name, gru_desc, gru_create_age, gru_last_post_age, gru_at) values ('Grupo Mclaren ','Grupo que junta pessoas com interesse na equipa de f1 Mclaren.',to_date('2022.09.9','YYYY.MM.DD'),TO_TIMESTAMP ('10-Sep-02 13:23:10.123000', 'DD-Mon-RR HH24:MI:SS.FF'),TRUE); -- Criação do grupo Mclaren.
insert into grupos (gru_name, gru_desc, gru_create_age, gru_last_post_age, gru_at) values ('Grupo Alpine','Grupo que junta pessoas com interesse na equipa de f1 Alpine.',to_date('2022.09.9','YYYY.MM.DD'),TO_TIMESTAMP ('10-Sep-02 13:23:10.123000', 'DD-Mon-RR HH24:MI:SS.FF'),TRUE); -- Criação do grupo Alpine.
insert into grupos (gru_name, gru_desc, gru_create_age, gru_last_post_age, gru_at) values ('Grupo Alfa Romeo','Grupo que junta pessoas com interesse na equipa de f1 Alfa Romeo.',to_date('2022.09.9','YYYY.MM.DD'),TO_TIMESTAMP ('10-Sep-02 13:23:10.123000', 'DD-Mon-RR HH24:MI:SS.FF'),TRUE); -- Criação do grupo Alfa Romeo.
insert into grupos (gru_name, gru_desc, gru_create_age, gru_last_post_age, gru_at) values ('Grupo Aston Martin','Grupo que junta pessoas com interesse na equipa de f1 Aston Martin.',to_date('2022.09.9','YYYY.MM.DD'),TO_TIMESTAMP ('10-Sep-02 13:23:10.123000', 'DD-Mon-RR HH24:MI:SS.FF'),TRUE); -- Criação do grupo Aston Martin.
insert into grupos (gru_name, gru_desc, gru_create_age, gru_last_post_age, gru_at) values ('Grupo Haas','Grupo que junta pessoas com interesse na equipa de f1 Haas.',to_date('2022.09.9','YYYY.MM.DD'),TO_TIMESTAMP ('10-Sep-02 13:23:10.123000', 'DD-Mon-RR HH24:MI:SS.FF'),TRUE); -- Criação do grupo Haas.
insert into grupos (gru_name, gru_desc, gru_create_age, gru_last_post_age, gru_at) values ('Grupo Alphatauri','Grupo que junta pessoas com interesse na equipa de f1 Alphatauri.',to_date('2022.09.9','YYYY.MM.DD'),TO_TIMESTAMP ('10-Sep-02 13:23:10.123000', 'DD-Mon-RR HH24:MI:SS.FF'),TRUE); -- Criação do grupo Alphatauri.
insert into grupos (gru_name, gru_desc, gru_create_age, gru_last_post_age, gru_at) values ('Grupo Williams','Grupo que junta pessoas com interesse na equipa de f1 Williams.',to_date('2022.09.9','YYYY.MM.DD'),TO_TIMESTAMP ('10-Sep-02 13:23:10.123000', 'DD-Mon-RR HH24:MI:SS.FF'),TRUE); -- Criação do grupo Williams.
...
insert into mensagem (mes_ug_id, mes_date, mes_text, mes_use_id) values (1, TO_TIMESTAMP ('22-Sep-22 14:10:10.123000', 'DD-Mon-RR HH24:MI:SS.FF'),'Alguém quer almoçar para depois ir ver a corrida?', 4); -- Manuel pergunta no grupo.
...
insert into eventos (eve_ug_id, eve_name, eve_desc, eve_evt_id, eve_date) values (4, 'Assistir a corrida em Santos!', 'Assistir a corrida em Santos que começa às 15 horas. Vamos nos encontrar ao pé da Taska da Txika às 14:45h!',3, TO_TIMESTAMP ('10-Sep-02 13:23:10.123000', 'DD-Mon-RR HH24:MI:SS.FF')); --Evento no grupo da Ferrari criado pelo Manuel Gusmão.
insert into eventos (eve_ug_id, eve_name, eve_desc, eve_evt_id, eve_date) values (6,'WatchParty','WatchParty no grupo de discord! Link do grupo:',3, TO_TIMESTAMP ('10-Out-22 14:10:10.123000', 'DD-Mon-RR HH24:MI:SS.FF')); --Evento no grupo da Alfa Romeo criado pelo Pablo Diaz. )
insert into eventos (eve_ug_id, eve_name, eve_desc, eve_evt_id, eve_date) values (5,'Beber um café', 'Vamos beber um café no Patio café, para falar sobre as estrategias da Alpine.',2, TO_TIMESTAMP ('25-Sep-22 14:10:10.123000', 'DD-Mon-RR HH24:MI:SS.FF'),3); --Evento no grupo da Alpine criado pelo José Almeida )
...
insert into localizacao (local_name, local_point) values ('Santos', 38.707093 -9.152712); -- Localização Santos.
insert into localizacao (local_name, local_point) values ('Belém', 38.697414 -9.199386);-- Localização Belém.
insert into localizacao (local_name, local_point) values ('Algés', 38.700895 -9.230866);-- Localização Algés.
insert into localizacao (local_name, local_point) values ('Oeiras', 38.696764 -9.314625); -- Localização Oeiras.
insert into localizacao (local_name, local_point) values ('Caxias', 38.702858 -9.269295);-- Localização Caxias.
