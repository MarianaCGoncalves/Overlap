...
import pt.iade.models.Repositories.TagsRepository;
...
public class TagsController { 
    ...
    public Tag getTag(@PathVariable int tag_id) throws NotFoundException {
        ...
        if (!_tag.isPresent()) throw new pt.iade.models.exceptions.NotFoundException("" +tag_id , "Tag", "id");
    ...
    public Tag getTagByName(@PathVariable String tag_name) throws NotFoundException {
        ...
        if (!_tag.isPresent()) throw new pt.iade.models.exceptions.NotFoundException(tag_name, tag_name, tag_name);
        else return _tag.get();
    }
